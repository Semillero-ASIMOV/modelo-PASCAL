...
k_r = 0.7; % Circulo de seguridad del punto de llegada [m]

Vxmax = 0.05; % Velocidad maxima del robot [m/s]
Vymax = 0.05; % Velocidad máxima del robot [m/s]
Wmax = 0.06; % Velocidad angular maxima del robot [rad/s]
